...
namespace Kfa.SubSystems.Cheques.Contracts.MvvmNavigation
{
    public abstract class NavigationManagerBase : INavigationManager
    {
        ...
        private void RaiseNavigated(NavigationEventArgs e) => Navigated?.Invoke(this, e);
        ...
        public bool CanNavigate(string navigationKey) => _dataStorage.IsExist(navigationKey);

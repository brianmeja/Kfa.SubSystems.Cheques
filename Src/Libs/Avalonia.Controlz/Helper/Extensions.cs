...
namespace Avalonia.Controlz.Helper
{
    ...
    public static class Extensions
    {
        ...
        {
            if (control.Parent is T) return (T)control.Parent;
        ...
        public static IEnumerable<IControl> GetChildObjects(this IControl parent, bool forceUsingTheVisualTreeHelper = false)
        {
            ...
            var parentLogical = parent as ILogical;
        ...
        {
            var parent = VisualTree.VisualExtensions.GetVisualParent(child);
...
#warning this does not work right now, avalonia throws an exception while using this attacheproperty in a style
        ...
        /// <returns></returns>
        public static Classes GetClasses(IStyledElement element) => element.GetValue(ClassesProperty);
        ...
        static void OnClassesChanged(IStyledElement element, Classes value)
        {
            if (value != null) element.Classes = value;
        }
    }
} 
...
namespace Avalonia.Controlz.Controls
{
    ...
    public class RangeBaseEx : RangeBase
    {
        ...
        void OnValueChanged(RangeBaseEx ctrl, AvaloniaPropertyChangedEventArgs e)
        {
        ...
        void OnMaximumChanged(RangeBaseEx ctrl, AvaloniaPropertyChangedEventArgs e)
        {
            //animationpeer missing ...
        ...
        void OnMinimumChanged(RangeBaseEx ctrl, AvaloniaPropertyChangedEventArgs e)
        {
            //animationpeer missing ...

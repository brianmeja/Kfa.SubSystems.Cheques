...
namespace Avalonia.Controlz.Controls
{
    ...
    {
        const string TrackName = "PART_Track";
        const string SelectionRangeElementName = "PART_SelectionRange";
        ...
        static void OnTickPlacementChanged(SliderEx slider, AvaloniaPropertyChangedEventArgs e)
        {
            if (slider.TopTickBar == null || slider.BottomTickBar == null) return;
        ...
        static void OnValueChanged(SliderEx slider, AvaloniaPropertyChangedEventArgs e)
        {
        ...
        static void OnSelectionEndChanged(SliderEx slider, AvaloniaPropertyChangedEventArgs e)
        {
            slider.UpdateSelectionRangeElementPositionAndSize();
        }

        static void OnSelectionStartChanged(SliderEx slider, AvaloniaPropertyChangedEventArgs e)
        {
        ...
        void OnMinimizeValueCommand(object x) => OnMinimizeValue();

        void OnMaximizeValueCommand(object x) => OnMaximizeValue();

        void OnDecreaseSmallCommand(object x) => OnDecreaseSmall();

        void OnIncreaseSmallCommand(object x) => OnIncreaseSmall();

        void OnDecreaseLargeCommand(object x) => OnDecreaseLarge();

        void OnIncreaseLargeCommand(object x) => OnIncreaseLarge();
        ...
        {
            if (change.Property == OrientationProperty && change.NewValue is Orientation newValue)
            {
        ...
        /// </summary>
        /// <param name="o"></param>
        void UpdatePseudoClassesForOrientation(Orientation o)
        {
        ...
        void UpdateValue(double value)
        {
            ...
            {
                this.SetValue(ValueProperty, Math.Max(Minimum, Math.Min(Maximum, snappedValue)));
            }
        }

        static void OnThumbDragCompleted(SliderEx sliderEx, VectorEventArgs args)
        {
            sliderEx.OnThumbDragCompleted(args);
        }

        static void OnThumbDragDelta(SliderEx sliderEx, VectorEventArgs args)
        {
            sliderEx.OnThumbDragDelta(args);
        }

        static void OnThumbDragStarted(SliderEx sliderEx, VectorEventArgs args)
        {
        ...
        protected virtual void OnThumbDragStarted(VectorEventArgs args)
        {
            ...
            if ((thumb == null) || (AutoToolTipPlacement == AutoToolTipPlacement.None)) return;
        ...
        void UpdateSelectionRangeElementPositionAndSize()
        {
            ...
            if (Track == null || DoubleUtil.LessThan(SelectionEnd, SelectionStart)) return;
            ...
            var rangeElement = SelectionRangeElement as Layoutable;
        ...
        void MoveToNextTick(double direction)
        {
            if (direction != 0.0)
            {
                ...
                double next = SnapToTick(Math.Max(Minimum, Math.Min(Maximum, value + direction)));
        ...
        void _OnMouseLeftButtonDown(PointerPressedEventArgs e)
        {
        ...
        /// </summary>
        protected virtual void OnIncreaseLarge() => MoveToNextTick(LargeChange);

        /// <summary>
        /// Call when Slider.DecreaseLarge command is invoked.
        /// </summary>
        protected virtual void OnDecreaseLarge() => MoveToNextTick(-LargeChange);

        /// <summary>
        /// Call when Slider.IncreaseSmall command is invoked.
        /// </summary>
        protected virtual void OnIncreaseSmall() => MoveToNextTick(SmallChange);

        /// <summary>
        /// Call when Slider.DecreaseSmall command is invoked.
        /// </summary>
        protected virtual void OnDecreaseSmall() => MoveToNextTick(-SmallChange);

        /// <summary>
        /// Call when Slider.MaximizeValue command is invoked.
        /// </summary>
        protected virtual void OnMaximizeValue() => this.SetValue(ValueProperty, Maximum);

        /// <summary>
        /// Call when Slider.MinimizeValue command is invoked.
        /// </summary>
        protected virtual void OnMinimizeValue() => this.SetValue(ValueProperty, Minimum);
    }
}
